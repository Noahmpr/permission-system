type Comment = {
  ...
  export  function basehasPermission<Resource extends keyof Permissions>(
    user: User,
    resource: Resource,
  ...
  basehasPermission(user, "comments", "create")
  
  // Can view the `todo` Todo
  basehasPermission(user, "todos", "view", todo)
  
  // Can view all todos
  basehasPermission(user, "todos", "view")